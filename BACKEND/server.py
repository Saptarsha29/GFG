...
# # MongoDB connection (Render par ye environment variables se aayega)
# mongo_url = os.environ.get("MONGO_URL")
# db_name = os.environ.get("DB_NAME", "ai_bi_dashboard")
...
# # ==========================================
# # CORS SETUP (Very Important for Vercel + Render)
# # ==========================================
# origins = [
#     "http://localhost:3000",
#     "http://localhost:5173",
...
# @api_router.get("/")
# async def root():
#     return {"message": "AI BI Dashboard API is running perfectly on Render!"}
...
# MongoDB connection (Render par ye environment variables se aayega)
mongo_url = os.environ.get("MONGO_URL")
db_name = os.environ.get("DB_NAME", "ai_bi_dashboard") # Default name de diya hai safety ke liye
...
origins = [
    "http://localhost:3000",         # React local server
    "http://localhost:5173",         # Vite local server
    "https://your-app.vercel.app"    # ⚠️ IMPORTANT: Deploy hone k baad apna asli Vercel URL yahan daalna!
]
